            ...
            <div class="row clearfix">
                <div class="col-md-12">
                    <div class="card">
                     ...
                     <select class="form-control select2 text-uppercase" name="customer_id" required>
                        <option value=""><?php echo $this->lang->line("search_customer_menu"); ?></option>
                        <?php foreach ($customer as $customers): ?>
                            <option value="<?php echo $customers->customer_id; ?>">
                                <?php echo strtoupper($customers->f_name . ' ' . $customers->m_name . ' ' . $customers->l_name . ' / ' . $customers->customer_code); ?>
                            </option>
                        <?php endforeach; ?>
                    </select>
