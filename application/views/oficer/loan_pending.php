                                ...
                                <table class="table table-hover js-basic-example dataTable table-custom">
                                   ...
                                   @$customer_condition = $this->queries->get_borrowe_alert($loan_pendings->customer_id);
                                    ...
                                    <a href="#" class="badge badge-info"><?php echo $this->lang->line("loan_disburse_menu"); ?></a>
                                        ...
                                        <td>
                                <?php 
                                    if ( $customer_condition->total_loan == 1) { // Check if the object and total_loan exist
                                  ?>
                        <span class="badge badge-success">
                            <?php echo $this->lang->line("new_customer_menu"); // "New customer" text ?>
                        </span>
                    <?php 
                    } else { 
                    ?>
                        <span class="badge badge-warning">
                            <?php echo $this->lang->line("old_customer_menu"); // "Old customer" text ?>
                        </span>
                    <?php 
                    } 
                    ?>
