...
<style> 
body {background-image: url('<?php echo base_url(); ?>assets/img/calculator.jpg'); background-repeat: no-repeat; background-attachment: fixed; background-size: 100% 100%; } </style> <!-- WRAPPER --> 
